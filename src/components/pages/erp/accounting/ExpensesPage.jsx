...
export const ExpensesPage = () => {
  ...
  const columns = [
    { key: 'description', header: 'Description' },
    {
      key: 'category',
      header: 'Category',
      render: (item) => (<Badge variant="secondary" className={categoryColors[item.category.toLowerCase()] || categoryColors.other}>
  ...
  return (<div className="space-y-6 animate-fade-in">
    ...
    <DataTable data={filteredExpenses} columns={columns} searchable searchKeys={['description']} />
  </div>);
};
