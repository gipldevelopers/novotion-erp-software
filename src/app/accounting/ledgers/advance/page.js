...
export default function AdvanceLedgersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold">Advance Ledgers</h2>
        <p className="text-sm acc-muted">
          Advance / prepaid ledger accounts
        </p>
      </div>
      ...
      <div className="acc-card overflow-x-auto">
        {advanceLedgers.length === 0 ? (
          <p className="acc-muted">
            No advance ledgers created yet.
          </p>
        ) : (
