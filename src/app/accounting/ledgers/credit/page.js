...
export default function CreditLedgersPage() {
  ...
  // Filter only CREDIT ledgers
  const creditLedgers = (ledgers || []).filter(
    (l) => l.type === "Credit"
  );
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-semibold">Credit Ledgers</h2>
        <p className="text-sm acc-muted">
          All credit-type ledger accounts
        </p>
      </div>
