...
export default function MyLeavesPage() {
    ...
    const [requestData, setRequestData] = useState({
        ...
        startDate: '',
        endDate: '',
        durationType: 'Full Day', // 'Full Day' or 'Half Day'
        halfDayType: 'First Half', // 'First Half' or 'Second Half'
        reason: ''
    });
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="text-sm text-muted-foreground">
                                                        ...
                                                        {leave.durationType === 'Half Day' && (
                                                            <Badge variant="secondary" className="ml-2 py-0 h-5 text-[10px] uppercase">
                                                                {leave.halfDayType}
                                                            </Badge>
                                                        )}
                                                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) => {
                                            const updates = { durationType: val };
                                            if (val === 'Half Day' && requestData.startDate) {
                                                updates.endDate = requestData.startDate;
                                            }
                                            setRequestData({ ...requestData, ...updates });
                                        }}
                                    >
                                        <SelectTrigger><SelectValue /></SelectTrigger>
                                        <SelectContent>
                                ...
                                {requestData.durationType === 'Half Day' && (
                                    <div className="grid gap-2">
                                        <Label>Session</Label>
                                        <Select
                                            value={requestData.halfDayType}
                                            onValueChange={(val) => setRequestData({ ...requestData, halfDayType: val })}
                                        >
                                            <SelectTrigger><SelectValue /></SelectTrigger>
                                            <SelectContent>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            const updates = { startDate: e.target.value };
                                            if (requestData.durationType === 'Half Day') {
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                        disabled={requestData.durationType === 'Half Day'}
                                    />
                                </div>
                            </div>
                            <div className="grid gap-2">
