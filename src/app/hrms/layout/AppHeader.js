...
//             className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-1 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden"
//           >
//             <svg
//               width="24"
//               height="24"
...
// import NotificationDropdown from "@/components/header/NotificationDropdown"; 
// import UserDropdown from "@/components/header/UserDropdown";
const NotificationDropdown = () => <div className="p-2">🔔</div>;
const UserDropdown = () => <div className="p-2">👤</div>;
        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/" className="lg:hidden">
            ...
            <Image
              ...
              height={32}
              className="hidden dark:block"
              src="/images/logo/GHR2.PNG" // Fixed this path
              alt="Logo"
            />
          </Link>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {loading ? "Loading..." : `Welcome back, ${user?.employee?.firstName || user?.name || user?.email}`}
          </p>
