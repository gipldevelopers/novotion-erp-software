          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-semibold text-blue-800 dark:text-blue-300">
                {payrollData.payrollPeriod || 'Not selected'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {selectedEmployees.map(employee => (
              <div key={employee.id} className="bg-white dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-green-600 dark:text-green-400">₹{employee.total}</p>
